 ...
 */
public final class SortingPlanet {
    /**
     * Empty constructor.
     */
    protected SortingPlanet() {
    }
     ...
     * @return sort3'7.
     */
    public static int[] sortTwisted37(final Integer[] array) {
     ...
     */
    public static int replace37(final int number) {
